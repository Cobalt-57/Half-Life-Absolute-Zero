...
#define EASY_CVAR_UPDATE_SERVER_MASS\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeDurationMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeDurationMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeRadiusMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeRadiusMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistHori)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistVertMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistVertMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeMultiColor)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserEnabled)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnFreq)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserLength)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistHoriMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistHoriMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistVertMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistVertMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserBrightnessMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserBrightnessMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserDurationMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserDurationMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserThicknessMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserThicknessMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserNoiseMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserNoiseMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserFrameRateMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserFrameRateMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserMultiColor)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedX)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedY)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedZ)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffX)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffY)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffZ)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedX)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedY)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedZ)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffX)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffY)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffZ)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(imAllFuckedUp)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(thatWasntGrass)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(thatWasntPunch)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogNear)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogFar)\
	EASY_CVAR_UPDATE_SERVER_DEBUGONLY(NPCsTalkMore)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(myCameraSucks)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(mutePlayerWeaponFire)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowColorMode)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashColorMode)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashSuitless)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDrownMode)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(forceDrawBatteryNumber)\
	EASY_CVAR_UPDATE_SERVER_DEBUGONLY(offsetgivedistance)\
	EASY_CVAR_UPDATE_SERVER_DEBUGONLY(offsetgivelookvertical)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(canShowWeaponSelectAtDeath)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(endlessFlashlightBattery)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(preE3UsesFailColors)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(E3UsesFailColors)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(preE3ShowsDamageIcons)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(E3ShowsDamageIcons)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogTest)\
	...
	DUMMY\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(allowAlphaCrosshairWithoutGuns)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(alphaCrosshairBlockedOnFrozen)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(sv_germancensorship)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primaryonly)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_reflectdealsdamage)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeanimdelay)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeworkdelay)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarychargetimereq)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primaryreflects)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primarypierces)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondaryreflects)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarypierces)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primarypunchthrough)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarypunchthrough)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_betweenattackdelay)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarychargemindelay)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeMaxAmmo_SP)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeMaxAmmo_MP)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeInterval_SP)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeInterval_MP)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDmgMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDmgExMult)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashCumulativeMinDrowning)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashCumulativeMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDrawOpacityMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowDrawOpacityMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowDrawOpacityMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashFadeMult)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowFadeMult)\
	EASY_CVAR_UPDATE_SERVER_CLIENTONLY_DEBUGONLY(painFlashArmorBlock)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDirTolerance)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowCumulativeAppearMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowCumulativeDmgJump)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashPrintouts)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashCumulativeJump)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashDrawOpacityMin)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashDrawOpacityMax)\
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashFadeMult)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(crossbowFirePlaysReloadSound)\
	...
	EASY_CVAR_UPDATE_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(iHaveAscended)\
...
#define EASY_CVAR_UPDATE_SERVER_DEDICATED_MASS\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeDurationMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeDurationMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeRadiusMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeRadiusMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistHori)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistVertMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistVertMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeMultiColor)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserEnabled)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnFreq)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserLength)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistHoriMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistHoriMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistVertMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistVertMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserBrightnessMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserBrightnessMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserDurationMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserDurationMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserThicknessMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserThicknessMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserNoiseMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserNoiseMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserFrameRateMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserFrameRateMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserMultiColor)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedX)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedY)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedZ)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffX)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffY)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffZ)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedX)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedY)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedZ)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffX)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffY)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffZ)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(imAllFuckedUp)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(thatWasntGrass)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(thatWasntPunch)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogNear)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogFar)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_DEBUGONLY(NPCsTalkMore)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(myCameraSucks)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(mutePlayerWeaponFire)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowColorMode)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashColorMode)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashSuitless)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDrownMode)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(forceDrawBatteryNumber)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(canShowWeaponSelectAtDeath)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(endlessFlashlightBattery)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(preE3UsesFailColors)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(E3UsesFailColors)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(preE3ShowsDamageIcons)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(E3ShowsDamageIcons)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogTest)\
	...
	DUMMY\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(allowAlphaCrosshairWithoutGuns)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(alphaCrosshairBlockedOnFrozen)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_DEBUGONLY(ignoreIsolatedNodes)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(sv_germancensorship)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED(gaussmode)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primaryonly)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_reflectdealsdamage)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeanimdelay)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeworkdelay)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarychargetimereq)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primaryreflects)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primarypierces)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondaryreflects)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarypierces)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primarypunchthrough)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarypunchthrough)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_betweenattackdelay)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarychargemindelay)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeMaxAmmo_SP)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeMaxAmmo_MP)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeInterval_SP)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeInterval_MP)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDmgMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDmgExMult)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashCumulativeMinDrowning)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashCumulativeMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDrawOpacityMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowDrawOpacityMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowDrawOpacityMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashFadeMult)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowFadeMult)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTONLY_DEBUGONLY(painFlashArmorBlock)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDirTolerance)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowCumulativeAppearMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowCumulativeDmgJump)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashPrintouts)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashCumulativeJump)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashDrawOpacityMin)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashDrawOpacityMax)\
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashFadeMult)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(crossbowFirePlaysReloadSound)\
	...
	EASY_CVAR_UPDATE_SERVER_DEDICATED_CLIENTSENDOFF_BROADCAST_DEBUGONLY(iHaveAscended)\
...
#define EASY_CVAR_SYNCH_SERVER_MASS\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(gruntsCanHaveMP5Grenade)\
	EASY_CVAR_SYNCH_SERVER(hud_version)\
	EASY_CVAR_SYNCH_SERVER(hud_batterydraw)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeDurationMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeDurationMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeRadiusMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeRadiusMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistHori)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistVertMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeSpawnDistVertMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(strobeMultiColor)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserEnabled)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnFreq)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserLength)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistHoriMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistHoriMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistVertMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserSpawnDistVertMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserBrightnessMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserBrightnessMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserDurationMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserDurationMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserThicknessMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserThicknessMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserNoiseMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserNoiseMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserFrameRateMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserFrameRateMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveLaserMultiColor)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedX)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedY)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosFixedZ)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffX)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffY)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraPosOffZ)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedX)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedY)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotFixedZ)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffX)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffY)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cameraRotOffZ)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(imAllFuckedUp)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(thatWasntGrass)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(thatWasntPunch)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogNear)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogFar)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(NPCsTalkMore)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(myCameraSucks)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(shutupstuka)\
	EASY_CVAR_SYNCH_SERVER(chromeEffect)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultSpinMovement)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultIdleSpinSound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultFireSound)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(muteBulletHitSounds)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(mutePlayerPainSounds)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultIdleSpinSoundChannel)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultSpinUpDownSoundChannel)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultFireSoundChannel)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(geigerChannel)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultWaitTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultSpinupRemainTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultResidualAttackTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultSpinupStartTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultVoicePitchMin)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultVoicePitchMax)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultFireSpread)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(muteTempEntityGroundHitSound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(houndeyeAttackMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(muteRicochetSound)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(mutePlayerWeaponFire)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(muteCrowbarSounds)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(scientistHealNPC)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(scientistHealNPCDebug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bulletholeAlertRange)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(fleshhitmakessound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(nothingHurts)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(seeMonsterHealth)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(scientistHealNPCFract)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidRangeDisabled)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(applyLKPPathFixToAll)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(timedDamageAffectsMonsters)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(scientistHealCooldown)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(crazyMonsterPrintouts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(movementIsCompletePrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bulletHoleAlertPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bulletholeAlertStukaOnly)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barneyPrintouts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(monsterSpawnPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(zombieBulletResistance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(zombieBulletPushback)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(houndeyePrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(quakeExplosionSound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(explosionDebrisSoundVolume)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(noFlinchOnHard)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultDrawLKP)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(meleeDrawBloodModeA)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(meleeDrawBloodModeB)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawDebugBloodTrace)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(meleeDrawBloodModeBFix)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(meleeDrawBloodModeAOffset)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(meleeDrawBloodModeBOffset)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST(wpn_glocksilencer)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(panthereyeHasCloakingAbility)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntForceStrafeFireAnim)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntLockRunAndGunTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntHeadshotGore)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntAllowStrafeFire)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(thoroughHitBoxUpdates)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntTinyClip)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntStrafeAlwaysHasAmmo)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntBrassEjectForwardOffset)\
	EASY_CVAR_SYNCH_SERVER(cl_muzzleflash)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(agrunt_muzzleflash)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(event5011Allowed)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(event5021Allowed)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(event5031Allowed)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(event5002Allowed)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(event5004Allowed)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(eventsAreFabulous)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(glockOldReloadLogic)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(glockOldReloadLogicBarney)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barneyDroppedGlockAmmoCap)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawCollisionBoundsAtDeath)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawHitBoundsAtDeath)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(islaveReviveFriendMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(islaveReviveFriendChance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(islaveReviveFriendRange)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(islaveReviveSelfMinDelay)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(islaveReviveSelfMaxDelay)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(islaveReviveSelfChance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntRunAndGunDistance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntPrintout)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(testVar)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowColorMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashColorMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashSuitless)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDrownMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(firstPersonIdleDelayMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(firstPersonIdleDelayMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(forceDrawBatteryNumber)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(offsetgivedistance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(offsetgivelookvertical)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(canShowWeaponSelectAtDeath)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(endlessFlashlightBattery)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(preE3UsesFailColors)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(E3UsesFailColors)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(preE3ShowsDamageIcons)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(E3ShowsDamageIcons)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(playerCrossbowMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassassinCrossbowMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(tripmineAnimWaitsForFinish)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(revolverLaserScope)\
	DUMMY\
	DUMMY\
	DUMMY\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY(auto_adjust_fov)\
	DUMMY\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cheat_infiniteclip)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cheat_infiniteammo)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cheat_minimumfiredelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cheat_minimumfiredelaycustom)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(cheat_nogaussrecoil)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(autoSneaky)\
	EASY_CVAR_SYNCH_SERVER(sv_longjump_chargemode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(cheat_touchNeverExplodes)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gaussRecoilSendsUpInSP)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawDebugPathfinding)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUcheckDistH)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUcheckDistV)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUcheckDistD)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUextraTriangH)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUextraTriangV)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUrepelMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUExplodeTest)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUYawSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(STUDetection)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(stukaAdvancedCombat)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawDebugPathfinding2)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultFriendlyFire)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(myStrobe)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(peopleStrobe)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(forceWorldLightOff)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(wildHeads)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(raveEffectSpawnInterval)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawBarnacleDebug)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(fogTest)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksAllMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksEnvMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksButtonMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksPlayerCrossbowMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksComputerHitMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksTurretDeathMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksOspreyHitMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksExplosionMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksBeamMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sparksAIFailMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(normalSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(noclipSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(jumpForceMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(apacheForceCinBounds)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(apacheBottomBoundAdj)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(apacheInfluence)\
	DUMMY\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(allowAlphaCrosshairWithoutGuns)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(alphaCrosshairBlockedOnFrozen)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntRunAndGunDotMin)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(panthereyeJumpDotTol)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(panthereyePrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(gargantuaPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(squadmonsterPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barnaclePrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(friendlyPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(stukaPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(timedDamageEndlessOnHard)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(mirrorsReflectOnlyNPCs)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(mirrorsDoNotReflectPlayer)\
	EASY_CVAR_SYNCH_SERVER(r_shadows)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(altSquadRulesRuntime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntLockStrafeTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(ignoreIsolatedNodes)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawNodeAll)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawNodeSpecial)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawNodeConnections)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawNodeAlternateTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(nodeSearchStartVerticalOffset)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(blockChangeLevelTrigger)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(blockMusicTrigger)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(blockMultiTrigger)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(blockTeleportTrigger)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(blockHurtTrigger)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(blockAutosaveTrigger)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hideNodeGraphRebuildNotice)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barnacleTongueRetractDelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(sv_germancensorship)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(allowGermanModels)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(germanRobotGibs)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(germanRobotBleedsOil)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(germanRobotDamageDecal)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(germanRobotGibsDecal)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(egonEffectsMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(egonHitCloud)\
	DUMMY\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(handGrenadePickupYieldsOne)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(handGrenadesUseOldBounceSound)\
	DUMMY\
	EASY_CVAR_SYNCH_SERVER(hud_moveselect_mousewheelsound)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(timedDamageDeathRemoveMode)\
	EASY_CVAR_SYNCH_SERVER(hud_moveselect_sound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barnacleCanGib)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(sentryCanGib)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(miniturretCanGib)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(turretCanGib)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(turretBleedsOil)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(turretDamageDecal)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(turretGibDecal)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(canDropInSinglePlayer)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(timedDamageIgnoresArmor)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(itemBatteryPrerequisite)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerExtraPainSoundsMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(timedDamageDisableViewPunch)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(batteryDrainsAtDeath)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(batteryDrainsAtAdrenalineMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(canTakeLongJump)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(printOutCommonTimables)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerBrightLight)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(disablePainPunchAutomatic)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(gargantuaCorpseDeath)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(gargantuaFallSound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(gargantuaBleeds)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(shrapMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(shrapRand)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(shrapRandHeightExtra)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(explosionShrapnelMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(useAlphaSparks)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(emergencyFix)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(timedDamageReviveRemoveMode)\
	DUMMY\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(ospreyIgnoresGruntCount)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(mp5GrenadeInheritsPlayerVelocity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(crossbowInheritsPlayerVelocity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(fastHornetsInheritsPlayerVelocity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(snarkInheritsPlayerVelocity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(chumtoadInheritsPlayerVelocity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(weaponPickupPlaysAnyReloadSounds)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(glockUseLastBulletAnim)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(playerBarnacleVictimViewOffset)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntMovementDeltaCheck)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hiddenMemPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultExtraMuzzleFlashRadius)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultExtraMuzzleFlashBrightness)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultExtraMuzzleFlashForward)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(leaderlessSquadAllowed)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(nodeConnectionBreakableCheck)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerReviveInvincibilityTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerReviveBuddhaMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerReviveTimeBlocksTimedDamage)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultBulletDamageMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultBulletsPerShot)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultFireAnimSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultMeleeAnimSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassassinCrossbowReloadSoundDelay)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntStrafeAnimSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntRunAndGunAnimSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(cheat_iwantguts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(nodeDetailPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(soundAttenuationStuka)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(soundVolumeStuka)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(cineChangelevelFix)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawDebugCine)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(cineAllowSequenceOverwrite)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(stukaInflictsBleeding)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(animationKilledBoundsRemoval)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(gargantuaKilledBoundsAssist)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitTrajTimeMin)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitTrajTimeMax)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitTrajDistMin)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitTrajDistMax)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitGravityMulti)\
	EASY_CVAR_SYNCH_SERVER(cl_bullsquidspit)\
	EASY_CVAR_SYNCH_SERVER(cl_bullsquidspitarc)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitUseAlphaModel)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitUseAlphaEffect)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectSpread)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectMin)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectMax)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectHitMin)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectHitMax)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectSpawn)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitEffectHitSpawn)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitSpriteScale)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(bullsquidSpitAlphaScale)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(scientistBravery)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barneyUnholsterTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barneyUnholsterAnimChoice)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(trailTypeTest)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetTrail)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetTrailSolidColor)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetDeathModEasy)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetDeathModMedium)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetDeathModHard)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetZoomPuff)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetSpiral)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hornetSpeedDartMulti)\
	EASY_CVAR_SYNCH_SERVER(cl_rockettrail)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(rocketTrailAlphaInterval)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(rocketTrailAlphaScale)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(rocketSkipIgnite)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(agruntHornetRandomness)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hornetSpiralPeriod)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hornetSpiralAmplitude)\
	EASY_CVAR_SYNCH_SERVER(cl_hornetspiral)\
	EASY_CVAR_SYNCH_SERVER(cl_hornettrail)\
	EASY_CVAR_SYNCH_SERVER(hud_drawammobar)\
	EASY_CVAR_SYNCH_SERVER(hud_weaponselecthideslower)\
	EASY_CVAR_SYNCH_SERVER(hud_drawsidebarmode)\
	EASY_CVAR_SYNCH_SERVER(gaussmode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primaryonly)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_reflectdealsdamage)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeanimdelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeworkdelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarychargetimereq)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primaryreflects)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primarypierces)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondaryreflects)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarypierces)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_primarypunchthrough)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarypunchthrough)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_betweenattackdelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_secondarychargemindelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeMaxAmmo_SP)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeMaxAmmo_MP)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeInterval_SP)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(gauss_chargeInterval_MP)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDmgMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDmgExMult)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashCumulativeMinDrowning)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashCumulativeMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDrawOpacityMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowDrawOpacityMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowDrawOpacityMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashFadeMult)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowFadeMult)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(painFlashArmorBlock)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashDirTolerance)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowCumulativeAppearMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painArrowCumulativeDmgJump)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(painFlashPrintouts)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashCumulativeJump)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashDrawOpacityMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashDrawOpacityMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(itemFlashFadeMult)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(chumtoadPrintout)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(crossbowReloadSoundDelay)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(crossbowFirePlaysReloadSound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindFidgetFailTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindPrintout)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindTopRampFixDistance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindTopRampFixDraw)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(iHaveAscended)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindLooseMapNodes)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindRampFix)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(chumtoadPlayDeadFoolChance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(animationFramerateMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindNodeToleranceMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(friendlyPianoFollowVolume)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(friendlyPianoOtherVolume)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(showtriggers)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(tentacleAlertSound)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(tentacleSwingSound1)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(tentacleSwingSound2)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerFollowerMax)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(announcerIsAJerk)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerUseDrawDebug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerChumtoadThrowDrawDebug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(peaceOut)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(drawViewModel)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(drawHUD)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(disablePauseSinglePlayer)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(playerBulletHitEffectForceServer)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(forceAllowServersideTextureSounds)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(playerWeaponSpreadMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(monsterAIForceFindDistance)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(baseEntityDamagePushNormalMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(baseEntityDamagePushVerticalBoost)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(baseEntityDamagePushVerticalMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(baseEntityDamagePushVerticalMinimum)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(viewModelPrintouts)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(viewModelSyncFixPrintouts)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(textureHitSoundPrintouts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hgruntAllowGrenades)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(scheduleInterruptPrintouts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(animationPrintouts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassaultMeleeAttackEnabled)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindStumpedWaitTime)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindStumpedMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindStumpedForgetEnemy)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindEdgeCheck)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(RadiusDamageDrawDebug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(AlienRadiationImmunity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(customLogoSprayMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(monsterFadeOutRate)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(playerFadeOutRate)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawDebugEnemyLKP)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(trackchangePrintouts)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(trackTrainPrintouts)\
	EASY_CVAR_SYNCH_SERVER(cl_holster)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(playerWeaponTracerMode)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(monsterWeaponTracerMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(decalTracerExclusivity)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(monsterToPlayerHitgroupSpecial)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(multiplayerCrowbarHitSoundMode)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(healthcolor_fullRedMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(healthcolor_brightness)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(healthcolor_yellowMark)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(cl_drawExtraZeros)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(pathfindLargeBoundFix)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(flyerKilledFallingLoop)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(floaterDummy)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barneyDummy)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(ladderCycleMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(ladderSpeedMulti)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(barnacleGrabNoInterpolation)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(hideDamage)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(timedDamage_brightnessMax)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(timedDamage_brightnessMin)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(timedDamage_brightnessCap)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(timedDamage_brightnessFloor)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(timedDamage_flashSpeed)\
	EASY_CVAR_SYNCH_SERVER_CLIENTONLY_DEBUGONLY(timedDamage_debug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(wallHealthDoor_closeDelay)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(houndeye_attack_canGib)\
	EASY_CVAR_SYNCH_SERVER_CLIENTSENDOFF_BROADCAST_DEBUGONLY(myRocketsAreBarney)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hassassinCrossbowDebug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(crossbowBoltDirectionAffectedByWater)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(kingpinDebug)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(minimumRespawnDelay)\
	EASY_CVAR_SYNCH_SERVER(r_glowshell_debug)\
	EASY_CVAR_SYNCH_SERVER(cl_viewpunch)\
	EASY_CVAR_SYNCH_SERVER(cl_explosion)\
	EASY_CVAR_SYNCH_SERVER(soundSentenceSave)\
	EASY_CVAR_SYNCH_SERVER(pissedNPCs)\
	EASY_CVAR_SYNCH_SERVER(hud_logo)\
	EASY_CVAR_SYNCH_SERVER(hud_brokentrans)\
	EASY_CVAR_SYNCH_SERVER(cl_fvox)\
	EASY_CVAR_SYNCH_SERVER(cl_ladder)\
	EASY_CVAR_SYNCH_SERVER(precacheAll)\
	EASY_CVAR_SYNCH_SERVER(cl_interp_entity)\
	EASY_CVAR_SYNCH_SERVER(hud_swapFirstTwoBuckets)\
	EASY_CVAR_SYNCH_SERVER(ignoreMultiplayerSkillOverride)\
	EASY_CVAR_SYNCH_SERVER(m_rawinput)\
	EASY_CVAR_SYNCH_SERVER(cl_earlyaccess)\
	EASY_CVAR_SYNCH_SERVER(cl_viewroll)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(drawDebugCrowbar)\
	EASY_CVAR_SYNCH_SERVER(blastExtraArmorDamageMode)\
	EASY_CVAR_SYNCH_SERVER(hud_batteryhiddendead)\
	EASY_CVAR_SYNCH_SERVER_DEBUGONLY(hyperBarney)\
	EASY_CVAR_SYNCH_SERVER(monsterKilledToss)\
	...
	EASY_CVAR_SYNCH_SERVER(cl_mp5_kickbackmode)\
	EASY_CVAR_SYNCH_SERVER(cl_breakholster)\
