...
// TODO!!!
// Support the custom CVar stuff without the temp variables to hold
// console values.  That is, just access console variables themselves when we need
// a variable.
// Probably a way to remove the need to check for the reference to a CVar being NULL too.
// Does it ever have to be checked again once it's found, or should it be re-checked on some
// event like loading a new map (probably including transitions if so)?
