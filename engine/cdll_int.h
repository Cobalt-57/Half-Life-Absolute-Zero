...
//MODDD - want to be careful about generic names like 'client'.  Call me paranoid.
extern void ClientDLL_TxferLocalOverrides( struct entity_state_s *state, const struct clientdata_s *pClient );
