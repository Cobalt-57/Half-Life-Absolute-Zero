...
//MODDD - new.
#define FTENT_FLASHONHIT		0x00100000 // Must specify callback.  Callback function is responsible for killing tempent and updating fields ( unless other flags specify how to do things )
//2^20

//Can we go further...?
#define FTENT_ORANGETRAIL		(1 << 21)
