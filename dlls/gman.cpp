...
#if EXTRA_NAMES > 0
	LINK_ENTITY_TO_CLASS( gman, CGMan );
...
void CGMan :: Spawn()
{
	...
	pev->classname = MAKE_STRING("monster_gman");
...
// Override all damage
//=========================================================
GENERATE_TAKEDAMAGE_IMPLEMENTATION(CGMan)
{
...
GENERATE_TRACEATTACK_IMPLEMENTATION(CGMan)
{
