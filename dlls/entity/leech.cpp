...
#if EXTRA_NAMES > 0
	LINK_ENTITY_TO_CLASS( leech, CLeech );
...
//	UTIL_SetSize( pev, g_vecZero, g_vecZero );
	...
	pev->classname = MAKE_STRING("monster_leech");
...
GENERATE_TRACEATTACK_IMPLEMENTATION(CLeech)
{
	GENERATE_TRACEATTACK_PARENT_CALL(CBaseMonster);
}

GENERATE_TAKEDAMAGE_IMPLEMENTATION(CLeech)
{
...
GENERATE_KILLED_IMPLEMENTATION(CLeech)
{
	Vector			vecSplatDir;
	TraceResult		tr;
