...
#if EXTRA_NAMES > 0
	LINK_ENTITY_TO_CLASS( nihilanth, CNihilanth );
	LINK_ENTITY_TO_CLASS( bigbaby, CNihilanth );
...
//no "monster" in front already?  Got nothing.
...
void CNihilanth::Spawn( void )
{
	...
	pev->classname = MAKE_STRING("monster_nihilanth");
...
GENERATE_KILLED_IMPLEMENTATION(CNihilanth)
{
...
GENERATE_TAKEDAMAGE_IMPLEMENTATION(CNihilanth)
{
...
GENERATE_TRACEATTACK_IMPLEMENTATION(CNihilanth)
{
	if (m_irritation == 3)
		m_irritation = 2;
