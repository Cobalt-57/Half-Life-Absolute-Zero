...
BOOL CPathCorner::IsWorldAffiliated(){
	return TRUE;
}
...
TYPEDESCRIPTION	CPathTrack::m_SaveData[] = 
{
	...
	//MODDD - to remember.
	DEFINE_FIELD( CPathTrack, PathTrackID, FIELD_INTEGER ),
...
BOOL CPathTrack::IsWorldAffiliated(){
	return TRUE;
}
...
int CPathTrack::PathTrackIDLatest = 0;



void CPathTrack :: Spawn( void )
{
	PathTrackID = PathTrackIDLatest;
	PathTrackIDLatest++;
