...
// MODDD - VecBModelOrigin moved to util.h/.cpp.
...
BOOL CFuncWallToggle::IsWorldAffiliated(){
	return TRUE;
}
...
BOOL CFuncIllusionary::IsWorldAffiliated(){
	return TRUE;
}
...
BOOL CFuncRotating::IsWorldAffiliated(){
	return TRUE;
}
...
BOOL CPendulum::IsWorldAffiliated(){
	return TRUE;
}
