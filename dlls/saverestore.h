...
#define IMPLEMENT_SAVERESTORE(derivedClass,baseClass) \
	...
	{\
		if ( !baseClass::Save(save) )\
			return 0;\
		int parentSaveResult = save.WriteFields( #derivedClass, this, m_SaveData, ARRAYSIZE(m_SaveData) );\
	...
	{\
		if ( !baseClass::Restore(restore) )\
			return 0;\
		int parentRestoreResult = restore.ReadFields( #derivedClass, this, m_SaveData, ARRAYSIZE(m_SaveData) );\
		derivedClass::PostRestore();\
		return parentRestoreResult;\
	}
...
//#endif
	...
	//MODDD - for being part of the save/restore system. Will be copied to the actually used static vars on Restore.
