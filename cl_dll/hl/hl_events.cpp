...
void Game_HookEvents( void )
{
	...
	//MODDD
	gEngfuncs.pfnHookEvent( "events/chumtoadfire.sc",				EV_SnarkFire );
	...
	gEngfuncs.pfnHookEvent( "events/customballsp.sc",			EV_ShowBallsPowerup );
	gEngfuncs.pfnHookEvent( "events/quakeexpfx.sc",				EV_QuakeExplosionEffect );
