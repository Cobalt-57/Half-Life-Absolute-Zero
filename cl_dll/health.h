...
//WARNING!!!   "1 << 31", as an integer, yields a negative number, probably from an integer overflow.
//Is that bad?    It is  -2147483648.

//MODDD - 2nd damge bitmask.
#define DMG_TIMEDEFFECT			(1<<0)
#define DMG_BLEEDING			(1<<1)
